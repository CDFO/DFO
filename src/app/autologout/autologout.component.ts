...
@Component({
  ...
  styleUrls: ['./autologout.component.css']
})
export class AutologoutComponent implements OnInit {
  ...
  reverseNumber(countdown: number) {
    ...
    return (this.global.idleAlertTimeout - (countdown - 1));
  }
  ...
  ngOnInit() {
    if (this.router.url != "/login"){
        ...
        this.idle.setIdle(this.global.idleTimeout);//900
        // sets a timeout period of 5 minutes.
        this.idle.setTimeout(this.global.idleAlertTimeout);
